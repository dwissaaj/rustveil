...
import { Select, SelectedItemProps, SelectItem, SharedSelection } from "@heroui/react";
...
export default function VerticesHome() {
  ...
  const renderChart = () => {
    switch(selectedChartType) {
      case "pie":
        return <VerticesGraphViewerPie data={graphData} />;
      case "bar":
    ...
    <div className="max-h-screen">
      <div className="w-full flex flex-col gap-2">
        <div className="m-2 w-1/2 ">
          <Select label="Select Chart Type" defaultSelectedKeys={"bar"}     variant="underlined" className="" 
            onSelectionChange={(selectedKeys: SharedSelection) => setSelectedChartType(selectedKeys.currentKey as string)}
            >
