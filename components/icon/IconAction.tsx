...
export const CloseActionIcon: React.FC<IconSvgProps> = ({
  size = 12,
  width = size,
  height = size,
  ...props
...
export const CloseActionIconOutline: React.FC<IconSvgProps> = ({
  size = 12,
  width,
  height,
  ...props
...
export const DownloadActionIconSolid: React.FC<IconSvgProps> = ({
  size = 12,
  width,
  height,
  ...props
